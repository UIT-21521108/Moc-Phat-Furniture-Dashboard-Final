...
# Bảng màu theo "màu sơn" (giữ đúng màu thực trên các chart liên quan)
COLOR_PALETTE = {
    "BROWN":   "#8B5A2B",
    "WHITE":   "#F2F2F2",
    "BLACK":   "#2E2E2E",
...
if _logo64:
    _img_tag = f"<img class='header-logo' src='data:image/png;base64,{_logo64}' alt='Moc Phat logo'/>"
else:
